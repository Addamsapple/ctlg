...
MoveToLastItem::MoveToLastItem(std::string &&modifier, std::string &&args) {}
...
MoveToFirstColumn::MoveToFirstColumn(std::string &&modifier, std::string &&args) {}
bool MoveToFirstColumn::execute() {
	itemColumnView.selectElement(0);
	return true;
}

MoveToLastColumn::MoveToLastColumn(std::string &&modifier, std::string &&args) {}
